                        ...
                        <tr class="transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.sections.destroy', $section) }}" class="inline" id="delete-form-section-{{ $section->id }}" data-modal="global-delete-modal">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" onclick="openDeleteModal('delete-form-section-{{ $section->id }}')" class="p-2 rounded-lg transition-colors text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30" title="Eliminar">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
