                            ...
                            <tr class="transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form method="POST" action="{{ route('admin.content_entries.destroy', ['client' => $client, 'section' => $section, 'entry' => $entry]) }}" class="inline" onsubmit="return confirm('¿Eliminar esta entrada?')">
                                            @csrf
                                            @method('DELETE')
