...
<div class="space-y-6">
    ...
    <div class="app-card rounded-xl">
        <form action="{{ route('client.sections.entries.update', ['section' => $section, 'entry' => $entry]) }}" method="POST" enctype="multipart/form-data" class="space-y-6 p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="title" id="title" value="{{ old('title', $entry->title) }}" class="app-input block w-full rounded-lg py-2 px-3 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="slug" id="slug" value="{{ old('slug', $entry->slug) }}" class="app-input block w-full rounded-lg py-2 px-3 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="datetime-local" name="published_at" id="published_at" value="{{ old('published_at', $entry->published_at?->format('Y-m-d\TH:i')) }}" class="app-input block w-full rounded-lg py-2 px-3 sm:text-sm sm:leading-6">
                    </div>
                </div>
            </div>
